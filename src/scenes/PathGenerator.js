...
export class PathGenerator {
     ...
     */
    static generateRandomPath(mapWidth, mapHeight) {
        const waypoints = [];
        ...
        for (let i = 0; i < this.numberOfTurningPoints; i++) {
            ...
            if (isHorizontal) {
                // Horizontal movement
                const lineLength = Phaser.Math.Between(this.minLineLength * mapWidth, this.maxLineLength * mapWidth);
                ...
                // Vertical movement
                const lineLength = Phaser.Math.Between(this.minLineLength * mapHeight, this.maxLineLength * mapHeight);
...
Object.defineProperty(PathGenerator, "margin", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 50
}); // Keep turningpoints away from edges
Object.defineProperty(PathGenerator, "minLineLength", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 0.05
}); // Minimum length of a straight line, given in percentage of the map width
Object.defineProperty(PathGenerator, "maxLineLength", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 0.25
}); // Maximum length of a straight line, given in percentage of the map width
Object.defineProperty(PathGenerator, "numberOfTurningPoints", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: Phaser.Math.Between(7, 10)
});
